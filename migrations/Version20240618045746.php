 ...
 */
final class Version20240618045746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, phone_number VARCHAR(50) NOT NULL, date_register DATETIME NOT NULL, picture VARCHAR(255) DEFAULT NULL, city VARCHAR(100) NOT NULL, portfolio VARCHAR(255) DEFAULT NULL, bio LONGTEXT NOT NULL, is_verified TINYINT(1) NOT NULL, is_verify TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
