...
class ServiceController extends AbstractController
{
    ...
    public function editService(?Service $service = null, EntityManagerInterface $entityManager, ImageService $imageService, Request $request): Response
    {
        ...
        if ($form->isSubmitted()) {
            ...
            if ($form->isValid()) {
                ...
                $originalFilename = $form->get->getPicture();
                ...
                if ($file instanceof UploadedFile) {
                    ...
                    try {
                        ...
                        $imageService->deleteImage($originalFilename, "SERVICE");
                        // On déplace la nouvelle et récupère son nom et extention
                        $fileName = $imageService->uploadImage($file, "SERVICE");
                        // On set a l'user
